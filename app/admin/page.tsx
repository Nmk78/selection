...
import CurrentResults from "@/components/ui/admin/CurrentResult";
import RoundManager from "@/components/ui/admin/RoundManager";
import SecretKeyManager from "@/components/ui/admin/SecretKeyManager";
import SpecialKeyManager from "@/components/ui/admin/SpecialKeyManager";
import CandidateForm from "@/components/ui/admin/CandidateForm";
import { Eye, EyeClosed, EyeClosedIcon, EyeOff, Plus, X } from "lucide-react";
import CandidateManager from "@/components/ui/admin/CandidateManager";
...
export default function AdminPage() {
  ...
  return (
    <div className="container max-w-7xl h-[85vh] mx-auto p-4 my-2">
      ...
      <Card className=" col-span-1 row-span-3 md:col-span-4 md:row-span-4">
        ...
        <CandidateManager classes=" md:col-span-3 row-span-4 md:row-span-5" setActiveModal={setActiveModal}/>
